...
import app.bxvip.com.myview.baan.Group;
import app.bxvip.com.myview.baan.People;
import app.bxvip.com.myview.widget.PinnedHeaderExpandableListView;
import app.bxvip.com.myview.widget.StickyLayout;
...
public class Main2Activity extends Activity implements
    ...
    /***
     * InitData 初始化数据，两个列表一个是标题列表，一个是子列表
     */
    void initData() {
    ...
    /***
     * 数据源 这是一个adapter相当于ListView和RecycleView中的adapter
     *
            ...
            if (convertView == null) {
                ...
                button.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(Main2Activity.this, "clicked pos=", Toast.LENGTH_SHORT).show();
                    }
                });
